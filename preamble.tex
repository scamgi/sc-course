...
\usepackage{amsthm}
\usepackage{framed} % Fornisce l'ambiente leftbar
...
% Ambiente corretto per gli esercizi con una barra a sinistra
\newenvironment{esercizio}[1]
  {\begin{leftbar}\begin{esercizioinner}[#1]}
  {\end{esercizioinner}\end{leftbar}}
